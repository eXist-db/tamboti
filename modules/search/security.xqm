...
as xs:string?
{
    if (sm:get-account-metadata($username, xs:anyURI("http://axschema.org/namePerson/first"))) 
    then
        concat
        (
            sm:get-account-metadata($username, xs:anyURI("http://axschema.org/namePerson/first")), " "
            ,
